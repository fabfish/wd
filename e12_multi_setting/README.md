...
3. **最优预算 C\* 的跨架构差异**：ResNet 系（R18 2C、R50 0.94C）与 VGG
   （1C）、MLP（1–1.5C）的最优预算都在 ~1–2C 窗口内；但 **崩塌边界因架构
   而异**：VGG/SGD 从 2C 起直接崩到随机水平（1–4% acc），R50/SGD 在
   2–3C 崩塌（linear_up 79.55@1C → 71.92@3C，iso 79.31@1C → 45.41@3C），
   R18/SGD 要到 3–7C 才崩。VGG 的 WD 容差窗口最窄，ResNet-18 最宽。
