...
|---|---|---|---|---|---|---|---|---|
| fixed (const λ) |  |  | **77.75 (λ=0.005)** |  |  |  |  |  |
| linear up | 76.98 | **77.53** |  |  |  | 76.59 |  |  |
| linear down | 77.08 |  | 77.22 | **78.04** | 76.92 | 77.18 | 76.37 | 72.91 |
| iso up | 76.69 | **77.31** |  |  |  | 57.74 |  |  |

## resnet18/cifar100 / SGDM

| wd_sched | 0.33 | 0.5 | 1 | 1.5 | 2 | 2.5 | 3 | 4 | 6 | 9 |
|---|---|---|---|---|---|---|---|---|---|---|
| fixed (const λ) | 75.56 (λ=0.0002) | 76.46 (λ=0.0003) | **77.45 (λ=0.0006)** |  | 77.13 (λ=0.0012) | 77.37 (λ=0.0015) | 76.19 (λ=0.001795) |  |  |  |
| linear up | 75.84 | 76.50 | 77.98 | 78.44 | **78.45** | 78.28 | 77.44 | 76.18 | 72.53 | 64.49 |
| linear down | 74.43 |  | **76.44** |  |  |  | 75.53 |  |  |  |
| iso up | 75.86 |  | **78.22** | 77.93 | 78.19 | 77.62 | 77.50 | 75.42 | 70.04 | 57.58 |

## resnet34/cifar100 / SGD

| wd_sched | 1 | 1.5 | 2 | 3 | 4 | 6 | 9 | 15 |
|---|---|---|---|---|---|---|---|---|
| fixed (const λ) | **78.87 (λ=0.005)** | 78.69 (λ=0.0075) | 78.66 (λ=0.01) |  | 77.07 (λ=0.02) |  |  |  |
...
| wd_sched | 1 | 1.5 | 2 | 3 | 4 | 6 | 9 | 15 |
|---|---|---|---|---|---|---|---|---|
| fixed (const λ) | **79.21 (λ=0.005)** | 78.98 (λ=0.0075) | 78.65 (λ=0.01) |  | 73.40 (λ=0.02) |  |  |  |
...
| wd_sched | 1 | 2 | 3 | 4 | 6 | 9 | 15 |
|---|---|---|---|---|---|---|---|
| fixed (const λ) | **76.08 (λ=0.0075)** |  |  |  |  |  |  |
...
| wd_sched | 0.33 | 0.5 | 1 | 1.5 | 2 | 2.5 | 3 | 4 |
|---|---|---|---|---|---|---|---|---|
| fixed (const λ) | 72.27 (λ=0.0003) | 72.72 (λ=0.0005) | **73.02 (λ=0.001)** |  | 72.39 (λ=0.002) |  | 71.16 (λ=0.003) |  |
