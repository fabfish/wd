"""
Plot v10 for exp1 LR ordering.
Based strictly on plot_exp1_v9.py (v3 logic).
Changes:
- Change SGDM (no WD) color to ORANGE to fix overlap/visibility issues vs SGD.
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    plt.tight_layout()
    output_path = output_dir / 'exp1_lr_ordering_v10.png'
