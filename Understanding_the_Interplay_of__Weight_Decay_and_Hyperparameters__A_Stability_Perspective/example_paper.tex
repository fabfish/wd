...
\usepackage{tabularx}
\usepackage{graphicx}
\usepackage{subcaption}     % 加载了 caption，无需 capt-of
\usepackage{array}
\usepackage{multirow}
\usepackage{makecell}
\usepackage{diagbox}
...
\newcommand{\en}[1]{{\color{red}{YANG: #1}}}
...
\twocolumn[
  \icmltitle{Understanding the Interplay of \\Weight Decay and Hyperparameters: A Stability Perspective}
...
\input{Chapters/3_Preliminary}
\input{Chapters/4_Generalization analysis}
\input{Chapters/5_Parameter setting}
